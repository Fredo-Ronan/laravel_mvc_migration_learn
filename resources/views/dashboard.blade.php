  ...
  <body>
    <div id="app">
        <nav class="navbar navbar-dark transparent-bg pt-0">
            <div class="ms-3 mt-3">
                <button class="btn btn-outline transparent-bg" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop" title="">
        ...
        <div class="offcanvas offcanvas-top h-100" tabindex="-1" id="offcanvasTop" aria-labelledby="offcanvasTopLabel">
            <div class="offcanvas-header">
                <button style="float:left;" class="btn btn-outline transparent-bg ms-2 mt-2" data-bs-dismiss="offcanvas"
                    aria-label="Close">
